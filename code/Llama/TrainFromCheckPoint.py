...
#loading Model State
checkpoint_path = "./.Llama3.2-3B-Fine-Tuning/Llama3B_joke_generator_lora_0.pt"
# model.load_state_dict(torch.load(models_path))

print("load check point")
checkpoint = torch.load(checkpoint_path)

print("get lora config")
lora_config = checkpoint['lora_config'] 
print("apply state dict")
...
jokes = pd.read_csv(TRAIN_PATH) #add the path to your Dataset in config File
